...
import com.example.rating.helper.Api;
import com.example.rating.helper.RequestHandler;
import com.example.rating.model.Player;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void refreshPlayerList(JSONArray heroes) throws JSONException {
        ...
        PlayerAdapter adapter = new PlayerAdapter(heroList);
    ...
    public class PlayerAdapter extends ArrayAdapter<Player> {
        ...
        public PlayerAdapter(List<Player> heroList) {
            super(MainActivity.this, R.layout.layout_player_list, heroList);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final Player hero = heroList.get(position);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (!object.getBoolean("error")) {
                    ...
                    refreshPlayerList(object.getJSONArray("heroes"));
                }
